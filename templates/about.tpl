...
{block name=body}
    ...
    <div id="main">
        <div id="m_content">
            ...
            <p class="clear"><br/></p>
            <p>Or you can just use this form:<br /><br /></p>
                <form action="http://www.gpgtools.org/mail.php" method="post" onsubmit="return encrypt();" name="feedback" id="feedback">
                    ...
                    <input style="width:1.5em;vertical-align:middle;" type=checkbox name="confidential" id="confidential" value="yes" onclick="toggleSecurity();"><span class="small">This is a private message, don't let the public see it</span><br/>
            ...
            <ul class="sub projects">
                <li><div class="project smallicons"><a href="http://twitter.com/gpgtools" title="follow us on twitter"><img src="{$root}/images/twitter.png" title="follow us on twitter" alt="twitter" /><br/>Follow us</a></div></li>
                <li><div class="project smallicons"><a href="https://plus.google.com/114902699475020542041/?prsrc=3" title="google+"><img src="{$root}/images/gplus-64.png" title="google+" alt="google+" /><br/>Circle us</a></div></li>
                <li><div class="project smallicons"><a href="http://twitter.com/statuses/user_timeline/170783148.rss" title="subscribe our twitter feed"><img src="{$root}/images/rss.png" title="subscribe our twitter feed" alt="rss" /><br/>Twitter Feed</a></div></li>
            ...
            <ul class="sub projects">
                ...
                <li><div class="project smallicons"><a href="http://lists.gpgtools.org/mailman/listinfo/gpgtools-users" title="join our mailing list"><img src="{$root}/images/mail.png" title="join our mailing list" alt="mailing list" /><br/>User List</a></div></li>
