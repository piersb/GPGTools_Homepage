    ...
    <div id="main">
        <div id="m_content">
            ...
            <ul class="sub">
                ...
                <li>Download our key: <a name="pgpkey" id="pgpkey" href="./files/gpgtools.asc" title="The GPGTools Project OpenGPG key">0x76D78F0500D026C4</a><br />Fingerprint: 85E3 8F69 046B 44C1 EC9F B07B 76D7 8F05 00D0 26C4</li>
                <li>Drop us a line:
