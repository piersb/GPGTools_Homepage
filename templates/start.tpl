...
{block name=body}
    ...
    <div id="main">
        <div id="m_content">
        <div id="announcement">
        <b>IMPORTANT:</b> We have a first preview of GPGMail for Mountain Lion. Get early access and help development by <a href="https://www.gpgtools.org/donate.html" title="10.8_Donate">donating</a>.<br>
