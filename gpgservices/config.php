...
$changelog = array(
    '1.8' => array(date("d. F Y", $release['1.8']), array(
        ...
        "74" => "<b>Symmetric encryption</b><br>One of the most requested GPGServices features has arrived. You can now encrypt with a password.<br><br>",
        "a" => "<b>Automatically informs you of new versions</b><br>The same update process you're familiar with from GPGMail is now included in GPGServices to always keep you up to date.<br><br>",
        "73" => "<b>Encrypt read-only text selections</b><br>Now GPGServices will work in most used browsers like Safari, Chrome, Firefox, Chromium and more as well as in Mail.app.<br><br>",
        "116" => "<b>Added Version information</b><br>Now displaying the version of GPGServices being used so users easily can find out which version they have.<br><br>",
